...
public class WithdrawDialog extends Dialog<Double> {
    private String amount;
    private TextField moneyAmount;

    public WithdrawDialog(String amount) {
        super();
        this.setTitle("Зняття грошей");
        this.amount = amount;
        buildUI();
        setResultConverter();
    }
    ...
    private Pane createGridPane() {
        ...
        Label moneyAmountLabel = new Label("Сума для зняття");
